 ...
 * @since 0.1.0
 */
public class StatusTypeHandler implements TypeHandler<TaskStatus> {

    public TaskStatus getResult(ResultSet rs, String param) throws SQLException {
    ...
    public TaskStatus getResult(CallableStatement cs, int col) throws SQLException {
        return ofString(cs.getString(col));
    }

    public void setParameter(PreparedStatement ps, int paramInt, TaskStatus paramType, JdbcType jdbcType)
            throws SQLException {
    ...
    private TaskStatus ofString(String s) {
        return s == null ? null : TaskStatus.valueOf(s);
    }
}
